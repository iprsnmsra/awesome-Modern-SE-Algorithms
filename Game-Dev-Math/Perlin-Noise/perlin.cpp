...
public:
    PerlinNoise() {
        vector<int> permutation = {151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,8,99,37,240,21,10,23,
...
int main() {
    ...
    double val1 = generator.noise(10.1, 10.1);
    double val2 = generator.noise(10.11, 10.1);
    
    double diff = abs(val1 - val2);
    
    assert(diff < 0.1);
    cout << "C++ Perlin Noise Test Passed! (Diff: " << diff << ")\n";
    return 0;
}